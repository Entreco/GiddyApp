...
object AspectRatioUtil {
    ...
    fun calculateWidth(height: Float, targetAspectRation: Float): Float {
        return targetAspectRation * height
    }

    fun calculateHeight(width: Float, targetAspectRation: Float): Float {
        return width / targetAspectRation
    }
}